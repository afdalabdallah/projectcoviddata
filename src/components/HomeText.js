...
export default function HomeText() {
    return (
        ...
        color="#545DCA"
            ...
            <GridItem marginTop="5%" rowSpan={3} colSpan={2} fontSize="60.78pt" fontWeight="700" color="#FFF" borderRadius="100px" bgColor="#6670DF" textAlign="center">2.123.013 kasus</GridItem>
